from base import SequentialModule, StatelessWrapper
...
class Linear(ModuleFactory):
    ...
    def __call__(self, in_shape, *args):
        return StatelessWrapper(nn.Linear(in_shape[0], self.out_size))
